...
function calculateArcs(data, selectedCounty) {
  ...
  if (!selectedCounty) {
    selectedCounty = data.find(f => f.properties.name === 'San Bernardino, CA'); //Los Angeles, CA
  }
...
export default function ArcLayerMap({data, strokeWidth = 1, mapStyle = MAP_STYLE}) {
